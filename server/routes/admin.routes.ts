...
import { validateBody, adminSendPasswordSchema } from "../../validation";
...
router.post("/api/admin/users/:id/unlock", authenticateToken, requireAdmin, adminController.unlockUser);
