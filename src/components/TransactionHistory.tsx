...
import { X, ArrowUpRight, ArrowDownLeft, Filter, ArrowRightLeft, Plus, ChevronDown, ChevronLeft, ChevronRight, Search, Loader2, WifiOff, Clock } from 'lucide-react';
...
export default function TransactionHistory({ 
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm p-0 lg:p-8">
      <div className="w-full h-full max-w-2xl bg-theme-surface shadow-2xl flex flex-col relative overflow-hidden animate-in slide-in-from-bottom duration-300 lg:rounded-2xl">
