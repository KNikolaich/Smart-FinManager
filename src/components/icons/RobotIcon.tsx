...
export const RobotIcon = ({ 
  ...
  return (
    ...
    >
      ...
      <rect x="5" y="38" width="8" height="30" rx="4" fill="currentColor" opacity={active ? "0.8" : "1"} />
      <rect x="87" y="38" width="8" height="30" rx="4" fill="currentColor" opacity={active ? "0.8" : "1"} />
      
      {/* Antennas */}
      <rect x="8" y="22" width="4" height="20" rx="2" fill="currentColor" opacity={active ? "0.8" : "1"} />
